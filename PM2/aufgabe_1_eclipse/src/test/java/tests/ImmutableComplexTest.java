...
public class ImmutableComplexTest {
    ...
    public void testDivision() {
        ...
        System.out.println(c3.divide(c4).getIm());
        System.out.println(new ImmutableComplex(36d/85, -77d/85).getIm());
        
        assertEquals(new ImmutableComplex(36d/85, -77d/85), c3.divide(c4));
    }
