...
\end{itemize}
\item Es ist zu erwarten, dass sich die finanzielle Situation im Jahre 2007 weiter verschlechtern wird
\end{itemize}
...
\centering
\begin{tikzpicture}
\node[draw] (a) at (1,0) {EAF};
\node[draw] (b) at (5,0) {ERP};
\node[draw] (c) at (0,-3) {SCM};
\node[draw] (d) at (3,-4) {CRM};
\node[draw] (e) at (6,-3) {E-Business};
